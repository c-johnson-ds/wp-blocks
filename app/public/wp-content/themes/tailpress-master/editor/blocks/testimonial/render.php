...
$author            = !empty(get_field( 'author' )) ? get_field( 'author' ) : 'John Doe';
$author_role       = !empty(get_field( 'role' )) ? get_field( 'role' ) : 'Chief Executive Officer';
$image             = get_field( 'image' );
$background_color  = !empty(get_field( 'background_color' )) ? get_field( 'background_color' ) : '#151515';
$text_color        = !empty(get_field( 'text_color' )) ? get_field( 'text_color' ) : '#FFF';
$quote_attribution = '';
